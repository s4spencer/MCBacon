...
namespace Starter
{
    ...
    retry:
            if (tries > 4)
            {
                ...
                Console.WriteLine("Go to http://mcbacon.co.cc/MCLawl_.dll yourself and download it, please");
            ...
            else
            {
                ...
                Console.WriteLine("Downloading from http:/mcbacon.co.cc/MCLawl_.dll");

                WebClient Client = new WebClient();
                Client.DownloadFile("http://mcbacon.co.cc/MCLawl_.dll", "MCLawl_.dll");
                Client.Dispose();
